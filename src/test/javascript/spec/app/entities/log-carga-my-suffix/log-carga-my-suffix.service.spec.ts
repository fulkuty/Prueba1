...
describe('Service Tests', () => {
    ...
    describe('LogCargaMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LogCargaMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/log-cargas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LogCargaMySuffix', () => {
