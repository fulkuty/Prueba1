...
describe('Service Tests', () => {
    ...
    describe('ZonaCargaMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ZonaCargaMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/zona-cargas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ZonaCargaMySuffix', () => {
