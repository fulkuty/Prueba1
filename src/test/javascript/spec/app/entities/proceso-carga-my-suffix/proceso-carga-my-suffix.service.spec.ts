...
describe('Service Tests', () => {
    ...
    describe('ProcesoCargaMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ProcesoCargaMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/proceso-cargas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProcesoCargaMySuffix', () => {
