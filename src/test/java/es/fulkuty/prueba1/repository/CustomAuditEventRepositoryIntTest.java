...
import es.fulkuty.prueba1.config.audit.AuditEventConverter;
import es.fulkuty.prueba1.domain.PersistentAuditEvent;
...
import static es.fulkuty.prueba1.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
